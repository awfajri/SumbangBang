 ...
 * @author User
 */
public class DashboardAdmin_semuaUser extends javax.swing.JFrame {
    ...
    private void loadTable() {
        ...
        DefaultTableModel model = adminDAO.getAllUsers();
        tableAllUsers.setModel(model);
    }
    ...
    private void initComponents() {
        ...
        labelDonasi.setText("User terbaru");
        ...
        tableAllUsers.setFont(new java.awt.Font("Lufga", 0, 12)); // NOI18N
    ...
    private void lblUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblUserMouseClicked
        // TODO add your handling code here:
        // Nanti: new DashboardAdmin_semuaUser(adminUser).setVisible(true);
        // this.dispose();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        // 1. Input Berurutan
        String name = javax.swing.JOptionPane.showInputDialog(this, "Masukkan Nama User:");
        if (name == null || name.isEmpty()) return;

        String email = javax.swing.JOptionPane.showInputDialog(this, "Masukkan Email:");
        if (email == null || email.isEmpty()) return;
        
        String pass = javax.swing.JOptionPane.showInputDialog(this, "Masukkan Password:");
        if (pass == null || pass.isEmpty()) return;

        String phone = javax.swing.JOptionPane.showInputDialog(this, "Masukkan No HP:");
        if (phone == null) phone = "";

        // Pilihan Role
        String[] roles = {"DONATUR", "PENERIMA", "ADMIN"};
        String role = (String) javax.swing.JOptionPane.showInputDialog(this, "Pilih Role:", "Input Role", 
                javax.swing.JOptionPane.QUESTION_MESSAGE, null, roles, roles[0]);
        if (role == null) return;
        
        String address = "Alamat Default Admin Input"; // Default untuk percepat

        // 2. Hash Password (Wajib pakai BCrypt agar bisa login)
        String passHash = org.mindrot.jbcrypt.BCrypt.hashpw(pass, org.mindrot.jbcrypt.BCrypt.gensalt());

        // 3. Simpan
        if (adminDAO.createUser(name, email, passHash, phone, role, address)) {
            javax.swing.JOptionPane.showMessageDialog(this, "User berhasil ditambahkan!");
            loadTable();
        } else {
            javax.swing.JOptionPane.showMessageDialog(this, "Gagal tambah user. Email mungkin duplikat.", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashboardAdmin_semuaUser().setVisible(true));
    }
